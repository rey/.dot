...
alias rec="yap listen-and-dictate --vtt --mic-label Rey --system-label 'Meeting Participant(s)' > ~/Documents/Meetings/Adhoc\ Transcriptions/$(date +'%Y-%m-%d-%H-%M')-adhoc-recording.vtt"
alias sudo="sudo "
alias tree="tree -C"
